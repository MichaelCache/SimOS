...
void main()
{
	...
	static struct GATE_DESCRIPTOR *idt= (struct GATE_DESCRIPTOR *)0x26f800;	//IDT address is 0x26f800
	...
	set_gatedec((struct GATE_DESCRIPTOR *)idt+0x21,enter_int_21,2*8,0x8e);	//create the INT 0x21 index
	set_gatedec((struct GATE_DESCRIPTOR *)idt+0x2c,enter_int_2c,2*8,0x8e);	//create the INT 0x21 index
